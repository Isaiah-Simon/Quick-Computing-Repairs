...
$yourURL = $baseURL . "admin/adminSearch.php";
        ...
        if (isset($_POST["btnSubmit"]) AND empty($errorMsg)) { 
            if ($searchBy=="status") { 
                        ...
                        foreach ($statuses as $status) {
								...
								print "<td><i><a href='http://www.uvm.edu/~isimon/cs148/assignment7.1/admin/adminView.php?q=" . $status['pkServiceNum'] . "'>View</a></i></td>\n";
								print "<td><i><a href='http://www.uvm.edu/~isimon/cs148/assignment7.1/admin/adminEdit.php?q=" . $status['pkServiceNum'] . "'>Edit</a></i></td>\n";
								print "<td><i><a href='http://www.uvm.edu/~isimon/cs148/assignment7.1/admin/adminDelete.php?q=" . $status['pkServiceNum'] . "'>Delete</a></i></td>\n";
                        ...
                        print "</table>\n";
							...
							foreach ($serviceNumSearches as $serviceNumSearch) {
									...
									print "<td><i><a href='http://www.uvm.edu/~isimon/cs148/assignment7.1/admin/adminView.php?q=" . $serviceNumSearch['pkServiceNum'] . "'>View</a></i></td>\n";
									print "<td><i><a href='http://www.uvm.edu/~isimon/cs148/assignment7.1/admin/adminEdit.php?q=" . $serviceNumSearch['pkServiceNum'] . "'>Edit</a></i></td>\n";
									print "<td><i><a href='http://www.uvm.edu/~isimon/cs148/assignment7.1/admin/adminDelete.php?q=" . $serviceNumSearch['pkServiceNum'] . "'>Delete</a></i></td>\n";
									print "</tr>\n";
									}
							} else {
